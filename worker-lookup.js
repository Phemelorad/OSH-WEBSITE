  ...
  window.attachWorkerLookup = function (config) {
    ...
    container.innerHTML = `
      ...
      <div class="wl-input-row">
        <input type="text" id="wl-id-input" placeholder="Enter Omang number…" maxlength="9" pattern="[0-9]{9}" inputmode="numeric"
    ...
    window.wlSetType = function (type) {
      ...
      if (type === 'Omang') {
        inp.maxLength = 9; inp.pattern = '[0-9]{9}'; inp.inputMode = 'numeric';
      } else {
